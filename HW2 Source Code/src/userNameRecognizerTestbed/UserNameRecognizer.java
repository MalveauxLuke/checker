	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 0: 
				...
				if ((currentChar >= 'A' && currentChar <= 'Z' ) ||		// Check for A-Z
					...
					// removed numbers line because first char must be a letter
			...
			case 1: 
				...
				//  3: a - or _ that also transitions to state 2
			...
			case 2: 
				...
				// only letters or digits will be here will go back to state 1
		...
		case 1:
			...
			if (userNameSize < 4) {
				...
				userNameRecognizerErrorMessage += 
					"A UserName character may only contain the characters A-Z, a-z, 0-9. Also special seperator chars ., -, or _ between the letters or digits.\n";
				return userNameRecognizerErrorMessage;
			}
			else {
					// UserName is valid
		...
		case 2:
			...
			userNameRecognizerErrorMessage +=
				"A UserName character after a period ., -, or _, must be A-Z, a-z, 0-9.\n";
			return userNameRecognizerErrorMessage;
