...
public class ControllerNewAccount {
	...
	*/
	...
	protected static void doCreateUser() {
		...
		String usernameErr = userNameRecognizerTestbed.UserNameRecognizer.checkForValidUserName(username);
		
		String passwordErr = passwordPopUpWindow.Model.evaluatePassword(password);
		...
		if (passwordErr != "") {
			...
			ViewNewAccount.alertUsernamePasswordError.setContentText(passwordErr);
			ViewNewAccount.alertUsernamePasswordError.showAndWait();
			return;
